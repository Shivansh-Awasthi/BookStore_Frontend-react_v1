...
import { BookOpen, Users, Award, Heart, Shield, Truck, Clock, Star } from 'lucide-react';
    ...
    const values = [
        {
            icon: Shield,
            title: 'Trust & Quality',
            description: 'Every book is carefully selected and verified for quality before reaching our customers.'
        },
        {
            icon: Heart,
            title: 'Customer First',
            description: 'Your reading experience is our top priority. We listen and adapt to your needs.'
        },
        {
            icon: Truck,
            title: 'Fast Delivery',
            description: 'Get your books delivered quickly with our efficient shipping partners.'
        },
        {
            icon: Award,
            title: 'Best Prices',
            description: 'We work directly with publishers to bring you the most competitive prices.'
        }
    ];
    ...
    const team = [
        {
            ...
            description: 'Passionate book lover with 10+ years in publishing industry.'
        },
        {
            name: 'Michael Chen',
        ...
        },
        {
            ...
            description: 'Literature expert who handpicks the best books for our collection.'
        },
        {
            name: 'David Kim',
            ...
            <section className="relative py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
                ...
                <div className={`relative max-w-7xl mx-auto text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    ...
                    <p className="text-xl md:text-2xl mb-8 opacity-90 max-w-3xl mx-auto">
                        Your trusted partner in discovering amazing book deals and literary adventures
                    </p>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                                Crazy Deals Online was born from a simple yet powerful idea: everyone deserves access to
                                amazing books at incredible prices. What started as a small online bookstore in 2020 has
                                grown into a beloved destination for book lovers across the country.
                            </p>
                            <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                                Our founder, Sarah Johnson, noticed that while people loved reading, the high cost of books
                                often limited their literary adventures. She envisioned a platform where readers could
                                discover new worlds without breaking the bank.
                            </p>
                            <p className="text-lg text-gray-700 leading-relaxed">
                                Today, we're proud to serve thousands of readers, offering carefully curated collections
                                across all genres while maintaining our commitment to affordability and quality.
                            </p>
                        </div>
                        <div className="relative">
                            <div className="bg-gradient-to-br from-blue-400 to-purple-500 rounded-2xl p-8 text-white h-80 flex items-center justify-center">
                                <div className="text-center">
                                    ...
                                    <p className="text-2xl font-bold italic">
                                        "Where every book is an adventure, and every deal is crazy good!"
                                    </p>
                                </div>
                            </div>
                            <div className="absolute -bottom-6 -left-6 bg-yellow-400 rounded-2xl p-6 w-64 h-64 flex items-center justify-center transform rotate-12 z-10">
                                <div className="text-center transform -rotate-12">
                                    <div className="text-3xl font-bold text-gray-900">50% OFF</div>
                                    <div className="text-gray-700 font-medium">On Best Sellers</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                        <div className="text-center lg:text-left">
                            ...
                            <p className="text-lg opacity-90 leading-relaxed">
                                To make reading accessible and affordable for everyone by providing
                                incredible deals on quality books while fostering a love for literature
                        ...
                        <div className="text-center lg:text-left">
                            ...
                            <p className="text-lg opacity-90 leading-relaxed">
                                To become the most trusted and loved online bookstore, where readers
                                of all ages can discover their next favorite book and join a vibrant
            ...
            <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-900 text-white">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
                        Join thousands of happy readers and discover amazing deals on your next favorite book.
                    </p>
            ...
            <footer className="bg-gray-800 text-white py-12">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="text-gray-400 mb-6 max-w-2xl mx-auto">
                        ...
                        Where every page begins a new journey.
                    </p>
                    ...
                    <div className="mt-6">
                        <p className="text-gray-500 text-sm">
                            Made with <span className="text-red-500">❤</span> for the reading community
                        </p>
                    </div>
                </div>
            </footer>
