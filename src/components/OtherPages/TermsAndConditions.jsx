        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-900 to-black text-gray-100 py-12 px-4 sm:px-6">
            <div className="max-w-4xl mx-auto">
                        ...
                        <div className="space-y-8">
                            ...
                            <section>
                                ...
                                <p className="text-gray-300 leading-relaxed">
                                    By accessing and using CrazyDealsOnline ("the Platform"), you accept and agree to be bound by these Terms and Conditions.
                                    If you disagree with any part of these terms, you may not access our platform or use our services.
                                </p>
                            </section>
                            ...
                            <section>
                                ...
                                <div className="bg-teal-900/20 border border-teal-700 rounded-lg p-6 mb-4">
                                    ...
                                    <p className="text-gray-300">
                                        You must be at least 13 years old to use our platform. If you are under 18,
                                ...
                                <div className="space-y-4">
                                    <div>
                                        ...
                                        <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4">
                                            ...
                                            <li>Payment must be completed before access to digital content is granted</li>
                                            <li>We use third-party payment processors (Razorpay) for secure transactions</li>
                                    ...
                                    <div>
                                        ...
                                        <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4">
                                            ...
                                            <li>Digital content is delivered immediately upon successful payment</li>
                                        </ul>
                                    </div>
                                </div>
                            </section>
                            ...
                            <section>
                                ...
                                <div className="bg-blue-900/20 border border-blue-700 rounded-lg p-6">
                                    ...
                                    <p className="text-gray-300 mb-4">
                                        All content available through CrazyDealsOnline, including but not limited to:
                                    </p>
                                    <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4">
                                    ...
                                    <p className="text-gray-300 mt-4">
                                        Are protected by copyright and intellectual property laws. You may not reproduce,
                                        distribute, modify, or create derivative works without explicit permission.
                                    </p>
                                </div>
                            </section>
                            ...
                            <section>
                                ...
                                <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4">
                                    <li>Access and use purchased digital content for personal, non-commercial purposes</li>
                                    <li>Download content to your personal devices for offline access</li>
                                    <li>Maintain a personal library of purchased materials</li>
                                </ul>
                                <p className="text-gray-300 leading-relaxed mt-4">
                                    This license does not permit redistribution, public performance, or commercial use.
                                </p>
                            </section>
                            ...
                            <section>
                                ...
                                <div className="bg-red-900/20 border border-red-700 rounded-lg p-6">
                                    ...
                                    <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4">
                                        ...
                                        <li>Redistributing, reselling, or sharing purchased content</li>
                                        <li>Reverse engineering, decompiling, or disassembling any software</li>
                                        <li>Using automated systems, bots, or scrapers to access the platform</li>
                            ...
                            <section>
                                ...
                                <p className="text-gray-300 leading-relaxed">
                                    By submitting content (reviews, comments, etc.) to our platform, you grant us
                                    a worldwide, non-exclusive, royalty-free license to use, modify, and display
                                    such content. You represent that you own or have the necessary rights to any
                                    content you submit.
                                </p>
                            </section>
                            ...
                            <section>
                                ...
                                <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4">
                                    ...
                                    <li>Termination does not affect any rights or obligations that arose prior to termination</li>
                            ...
                            <section>
                                ...
                                <p className="text-gray-300 leading-relaxed">
                                    ...
                                    error-free, or completely secure. Your use of the platform is at your sole risk.
                                </p>
                            </section>
                            ...
                            <section>
                                ...
                                <div className="bg-orange-900/20 border border-orange-700 rounded-lg p-6">
                                    <p className="text-gray-300">
                                        To the fullest extent permitted by law, CrazyDealsOnline shall not be liable for
                ...
                <div className="bg-gradient-to-r from-gray-800 to-gray-900 rounded-xl border border-gray-700 p-6 mb-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="bg-cyan-900/20 p-4 rounded-lg border border-cyan-800">
                            <h4 className="font-semibold text-cyan-400 mb-2">Your Responsibilities</h4>
                            <ul className="text-gray-300 text-sm space-y-1">
                ...
                <div className="bg-gradient-to-r from-gray-800 to-gray-900 rounded-xl border border-gray-700 p-6 mb-8 text-center">
                    ...
                    <p className="text-gray-300">
                        By using CrazyDealsOnline, you acknowledge that you have read, understood,
                ...
                <div className="text-center space-y-4">
                    <div className="flex flex-wrap justify-center gap-6 text-sm text-gray-400">
                        ...
                        <Link to="/policy" className="hover:text-teal-400 transition-colors">
                            Privacy Policy
                        </Link>
                        <Link to="/return-policy" className="hover:text-teal-400 transition-colors">
                            Return Policy
                        </Link>
                        <Link to="/refund-policy" className="hover:text-teal-400 transition-colors">
                            Refund Policy
                        </Link>
                        <Link to="/disclaimer" className="hover:text-teal-400 transition-colors">
                            Disclaimer
                        </Link>
                    </div>
