            ...
            <div className="max-w-4xl mx-auto">
                        ...
                        <div className="space-y-8">
                            ...
                            <section>
                                ...
                                <p className="text-gray-300 leading-relaxed">
                                    At CrazyDealsOnline, we want you to be completely satisfied with your purchase.
                                    This refund policy outlines the circumstances under which refunds are provided
                                ...
                                <div className="space-y-6">
                                    <div className="bg-emerald-900/20 border border-emerald-700 rounded-lg p-6">
                                        ...
                                        <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4">
                                            <li>
                                                <strong>Order Cancellations:</strong> Full refund for orders cancelled within 48 hours of placement
                                            </li>
                                            <li>
                                                <strong>Duplicate Payments:</strong> Refund for accidental duplicate transactions
                                            </li>
                                            <li>
                                                <strong>Failed Deliveries:</strong> Refund if order cannot be delivered due to technical issues
                                            </li>
                                            <li>
                                                <strong>Incorrect Charges:</strong> Refund for billing errors or incorrect amounts charged
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <section>
                                ...
                                <div className="bg-red-900/20 border border-red-700 rounded-lg p-6">
                                    ...
                                    <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4">
                                        ...
                                        <li>Digital content that has been accessed, downloaded, or delivered</li>
                                        <li>Change of mind after purchase</li>
                                        <li>Products that have been partially used or accessed</li>
                                        <li>Orders where delivery was successful and content was accessible</li>
                                    </ul>
                                </div>
                            </section>
                            ...
                            <section>
                                ...
                                <div className="bg-gray-700/50 rounded-lg p-6 mb-4">
                                    <ol className="list-decimal list-inside text-gray-300 space-y-3 ml-4">
                                        <li className="pb-2">
                                            <strong>Request Submission:</strong> Submit refund request through your account or via email
                                        </li>
                                        <li className="pb-2">
                                            <strong>Verification:</strong> We verify eligibility based on our policy terms
                                        </li>
                                        <li className="pb-2">
                                            <strong>Approval:</strong> Eligible refunds are approved within 24-48 hours
                                        </li>
                                        <li className="pb-2">
                                            <strong>Processing:</strong> Refund is processed to your original payment method
                                        </li>
                                        <li>
                                            <strong>Completion:</strong> Refund appears in your account within 5-10 business days
                                        </li>
                                    </ol>
                                </div>
                            </section>
                            ...
                            <section>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                                    <div className="bg-gray-700/50 p-4 rounded-lg text-center">
                                        <div className="text-emerald-400 font-bold text-lg">24-48 Hours</div>
                                        <div className="text-gray-300 text-sm">Request Verification</div>
                                    </div>
                                    <div className="bg-gray-700/50 p-4 rounded-lg text-center">
                                        <div className="text-emerald-400 font-bold text-lg">1-2 Days</div>
                                        <div className="text-gray-300 text-sm">Refund Processing</div>
                                    </div>
                                    <div className="bg-gray-700/50 p-4 rounded-lg text-center">
                                        <div className="text-emerald-400 font-bold text-lg">5-10 Days</div>
                                        <div className="text-gray-300 text-sm">Bank Processing</div>
                                    </div>
                                </div>
                                <p className="text-gray-300 text-sm">
                                    Note: The time it takes for the refund to reflect in your account depends on your bank or payment provider.
                                </p>
                            </section>
                            ...
                            <section>
                                ...
                                <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4">
                                    <li>
                                        <strong>Credit/Debit Cards:</strong> Refunded to the same card (5-10 business days)
                                    </li>
                                    <li>
                                        <strong>UPI Payments:</strong> Refunded to the same UPI ID (3-5 business days)
                                    </li>
                                    <li>
                                        <strong>Net Banking:</strong> Refunded to the same bank account (5-7 business days)
                                    </li>
                                    <li>
                                        <strong>Digital Wallets:</strong> Refunded to the same wallet (2-3 business days)
                                    </li>
                                </ul>
                            </section>
                            ...
                            <section>
                                ...
                                <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4 mt-2">
                                    <li>Bundled products where only part of the content is undeliverable</li>
                            ...
                            <section>
                                ...
                                <div className="bg-blue-900/20 border border-blue-700 rounded-lg p-6">
                                    ...
                                    <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4">
                                        ...
                                        <li>Refund is considered only if issue cannot be resolved</li>
                                    </ul>
                                </div>
                            </section>
                            ...
                            <section>
                                ...
                                <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4 mt-2">
                                    ...
                                    <li>Include: Order number, purchase date, and reason for refund</li>
                ...
                <div className="bg-gradient-to-r from-gray-800 to-gray-900 rounded-xl border border-gray-700 p-6 mb-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="bg-emerald-900/20 p-4 rounded-lg border border-emerald-800">
                            <h4 className="font-semibold text-emerald-400 mb-2">Refund Rights</h4>
                ...
                <div className="text-center space-y-4">
                    <div className="flex flex-wrap justify-center gap-6 text-sm text-gray-400">
                        ...
                        <Link to="/policy" className="hover:text-emerald-400 transition-colors">
                            Privacy Policy
                        </Link>
                        <Link to="/return-policy" className="hover:text-emerald-400 transition-colors">
                            Return Policy
                        </Link>
                        <Link to="/contact-us" className="hover:text-emerald-400 transition-colors">
                            Contact
                        </Link>
                    </div>
