                ...
                <div className="grid grid-cols-4 gap-8 mb-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm text-gray-600">
                            <li><button onClick={() => navigate("/about-us")} className="hover:text-navy">About</button></li>
                            <li><button className="hover:text-navy">Blog</button></li>
                            <li><button className="hover:text-navy">Brands</button></li>
                        </ul>
                    </div>
                    <div>
                        <h4 className="font-bold text-navy mb-4">Community</h4>
                        <ul className="space-y-2 text-sm text-gray-600">
                            <li><button className="hover:text-navy">Forum</button></li>
                            <li><button className="hover:text-navy">Advertising</button></li>
                            <li><button className="hover:text-navy" onClick={() => navigate('/contact-us')}>Contact us</button></li>
                        </ul>
                    </div>
                    <div>
                        <h4 className="font-bold text-navy mb-4">Legal</h4>
                        <ul className="space-y-2 text-sm text-gray-600">
                            <li><button className="hover:text-navy" onClick={() => navigate('/privacy-policy')}>Privacy</button></li>
                            <li><button className="hover:text-navy">Policy</button></li>
                            <li><button className="hover:text-navy">Condition</button></li>
                        </ul>
                    </div>
                </div>
