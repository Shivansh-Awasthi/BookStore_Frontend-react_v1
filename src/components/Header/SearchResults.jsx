...
import { Search, Filter, Grid, List, ChevronLeft, ChevronRight, Star, BookOpen } from 'lucide-react';
    ...
    const fetchSearchResults = async () => {
        ...
        try {
            ...
            const response = await fetch(
                `${process.env.VITE_API_URL}/api/books/search?q=${encodeURIComponent(searchQuery)}&page=${currentPage}&limit=${itemsPerPage}&sort=${sortField}&order=${sortOrder}`
            );
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                {books.length === 0 ? (
                    ...
                    <>
                        ...
                        >
                            {books.map((book) =>
                                viewMode === 'grid' ? renderBookCard(book) : renderBookListItem(book)
                            )}
                        </div>
