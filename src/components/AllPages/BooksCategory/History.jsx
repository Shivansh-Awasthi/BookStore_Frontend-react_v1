        ...
        const fetchHistoryBooks = async () => {
            try {
                ...
                const response = await fetch(
                    `${process.env.VITE_API_URL}/api/books/category/History/?page=${currentPage}&limit=12`
                );
    ...
    const BookCard = ({ book }) => (
        <div className="bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100 overflow-hidden group">
            <div className="relative overflow-hidden">
                ...
                />
                <div className="absolute top-2 right-2 bg-gradient-to-r from-amber-500 to-orange-500 text-white px-2 py-1 rounded-full text-xs font-semibold">
                    {book.format}
                </div>
                {book.stock > 0 && (
        ...
        return (
            <div className="min-h-screen bg-gradient-to-br from-amber-50 to-orange-50 flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="mt-4 text-gray-600">Loading history books...</p>
                </div>
            </div>
        );
    }
        ...
        <div className="min-h-screen bg-gradient-to-br from-amber-50 to-orange-50">
            ...
            <div className="relative bg-gradient-to-r from-amber-600 via-orange-600 to-red-500 text-white py-20 px-4">
                ...
                <div className="relative max-w-7xl mx-auto text-center">
                    ...
                    <p className="text-xl md:text-2xl mb-8 opacity-90">
                        Journey Through Time with Our Collection of Historical Masterpieces
                    </p>
            ...
            <div className="max-w-7xl mx-auto px-4 py-12">
                ...
                <div className="text-center mb-12">
                    ...
                    <p className="text-gray-600 text-lg max-w-3xl mx-auto">
                        Discover fascinating stories from ancient civilizations, medieval times,
                        world wars, and modern history. Our collection brings the past to life!
                    </p>
                </div>
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-center">
                        <div>
                            <h3 className="text-2xl font-bold text-gray-800">
                                {books.length} History Books Found
                            </h3>
                ...
                {books.length > 0 ? (
                    ...
                    <div className="text-center py-16">
                        ...
                        <p className="text-gray-600 mb-6">We couldn't find any history books at the moment.</p>
                        <button
                            onClick={() => navigate('/')}
                ...
                <div className="bg-gradient-to-r from-amber-500 to-orange-600 rounded-2xl p-8 text-center text-white mt-16 shadow-2xl">
                    ...
                    <p className="text-xl mb-6 opacity-90">
                        Sign up for our history newsletter and get updates on new arrivals and exclusive deals!
                    </p>
            ...
            <footer className="bg-gray-800 text-white py-12 mt-16">
                <div className="max-w-7xl mx-auto px-4 text-center">
                    <h3 className="text-2xl font-bold mb-4">History Books Collection</h3>
                    <p className="text-gray-400 mb-6">
                        Your gateway to the past - Explore, Learn, and Discover
                    </p>
