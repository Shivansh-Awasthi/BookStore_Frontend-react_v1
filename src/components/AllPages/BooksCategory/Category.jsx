...
const Category = () => {
    ...
    const getCategoryDescription = (category) => {
        const descriptions = {
            'Science': 'Discover the wonders of the universe and scientific breakthroughs',
            'History': 'Journey through time and explore the events that shaped our world',
            ...
            'Biography': 'Inspiring stories of remarkable people and their life journeys',
        ...
        return descriptions[category] || `Explore our collection of ${category} books`;
    };
    ...
    const CategoryCard = ({ category, index }) => (
        ...
        >
            {/* Main Card */}
            <div className={`bg-gradient-to-br ${getCategoryGradient(category, index)} rounded-3xl p-8 h-64 flex flex-col justify-between text-white shadow-2xl hover:shadow-3xl transition-all duration-500 group-hover:rotate-1 border-2 border-white border-opacity-20`}>
        ...
        return (
            <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 flex items-center justify-center">
                <div className="text-center">
                    ...
                    <h2 className="text-2xl font-bold text-gray-700 mb-2">Discovering Categories</h2>
            ...
            <div className="relative bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-700 text-white py-20 px-4 overflow-hidden">
                ...
                <div className="relative max-w-7xl mx-auto text-center">
                    ...
                    <p className="text-xl md:text-2xl mb-8 opacity-90 max-w-3xl mx-auto">
                        ...
                        Each category holds unique stories waiting to be discovered.
                    </p>
            ...
            <div className="max-w-7xl mx-auto px-4 py-12">
                ...
                <div className="text-center mb-12">
                    <div className="inline-block bg-white rounded-2xl shadow-lg px-8 py-4 mb-6">
                        ...
                        <p className="text-gray-600">Explore our diverse book collections</p>
                    </div>
                </div>
                ...
                <div className="bg-gradient-to-r from-blue-500 to-purple-600 rounded-3xl p-12 text-center text-white mt-16 shadow-2xl relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
                            Use our advanced search to find specific books or contact us for special requests.
                        </p>
            ...
            <footer className="bg-gray-800 text-white py-12 mt-16">
                <div className="max-w-7xl mx-auto px-4 text-center">
                    ...
                    <p className="text-gray-400 mb-6 max-w-2xl mx-auto">
                        Your gateway to endless stories and knowledge across all genres and interests.
                    </p>
